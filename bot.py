...
TOKEN = os.environ.get("TOKEN", "8611723015:AAG_BEZDeuzjVPgF271bHgnJF5WVIW0zA_U")  

# Причины, почему я тебя люблю
LOVE_REASONS = [
    "Я люблю тебя за твою улыбку, которая освещает даже самый пасмурный день.",
    "Я люблю тебя за то, как ты заботишься обо мне, даже когда сама устала.",
    "Я люблю тебя за твой смех — он самый искренний звук в моей жизни.",
    "Я люблю тебя за твою доброту к людям и животным.",
    "Я люблю тебя за то, как ты хмуришь бровки, когда сосредоточена.",
    "Я люблю тебя за наши разговоры до утра.",
    "Я люблю тебя за то, что с тобой я могу быть собой.",
    "Я люблю тебя за твои маленькие привычки, которые стали такими родными.",
    "Я люблю тебя за то, как ты поддерживаешь меня в трудные моменты.",
    "Я люблю тебя просто потому, что ты есть.",
    "Я люблю тебя за то, как твои глаза загораются, когда ты говоришь о том, что тебя вдохновляет.",
    "Я люблю тебя за то, как ты смешно потягиваешься по утрам.",
    "Я люблю тебя за твое терпение и умение выслушать, не перебивая.",
    "Я люблю тебя за твою непосредственность и детскую искренность.",
    "Я люблю тебя за то, как ты готовишь (или за то, как ты радуешься, когда я готовлю для тебя).",
    "Я люблю тебя за то, что ты веришь в меня, даже когда я сам в себя не верю.",
    "Я люблю тебя за тепло твоих ладоней и твои объятия, в которые хочется возвращаться снова и снова.",
    "Я люблю тебя за то, как ты играешь словами и за твое чувство юмора.",  
    "Я люблю тебя за то, как ты пританцовываешь, когда чему то рада",
    "Я люблю тебя за твоб прекрасную улыбку, освещающую мою жизнь",
    "Я люблю тебя за то, как сильно ты стараешься ради меня",
    "Я люблю тебя за твой нежный голос, что успокоит меня в тяжелый момент",
    "Я люблю тебя за твоб прекрасную фигуру, которая невероятно меня возбуждает",
    "Я люблю тебя за твое трудолюбие, что мотивирует меня идти дальше",
    "Я люблю тебя за нежность и вкус твоих губ",
    "Я люблю тебя за твои слова поддержки и мотивацию, что даешь мне каждый день",
    "Я люблю тебя за твои теплые объятия по утрам, когда мне куда то надо",
    "Я люблю тебя за то, что даже на расстоянии я ни разу не усомнился в твоих чувствах ко мне"
]

# Комплименты
COMPLIMENTS = [
    "Ты сегодня невероятно красива.",
    "Твои глаза сегодня особенно сияют.",
    "С тобой даже обычный день становится праздником.",
    "Твое присутствие делает мир лучше.",
    "Ты самая теплая и уютная вселенная.",
...
SUPPORT_WORDS = [
    ...
    "Ты сильнее, чем думаешь, и я верю в тебя.",
    "Просто помни: я тебя люблю, и это главное.",
